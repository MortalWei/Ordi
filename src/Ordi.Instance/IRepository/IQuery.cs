...
namespace Ordi
{
    ...
    internal interface IQuery
    {
        ...
        /// <param name="sqlStr">待执行的脚本</param>
        /// <returns></returns>
        IEnumerable<T> Query<T>(string sqlStr);
        ...
        /// <param name="timeOut">超时时间</param>
        /// <returns></returns>
        IEnumerable<T> Query<T>(string sqlStr, int timeOut);
        ...
        /// <param name="dbs">参数集合</param>
        /// <returns></returns>
        IEnumerable<T> Query<T>(string sqlStr, DbParameter[] dbs);
        ...
        /// <param name="timeOut">超时时间</param>
        /// <returns></returns>
        IEnumerable<T> Query<T>(string sqlStr, DbParameter[] dbs, int timeOut);
        ...
        /// <param name="commandType">脚本类型</param>
        /// <returns></returns>
        IEnumerable<T> Query<T>(string sqlStr, DbParameter[] dbs, CommandType commandType);
        ...
        /// <param name="timeOut">超时时间</param>
        /// <returns></returns>
        IEnumerable<T> Query<T>(string sqlStr, DbParameter[] dbs, CommandType commandType, int timeOut);
    }
}
